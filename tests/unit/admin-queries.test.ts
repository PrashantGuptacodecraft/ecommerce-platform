...
const { 
  mockQueryBuilder, mockSelect, mockEq, mockGt, mockLt, mockGte, 
  mockIlike, mockOr, mockIn, mockOrder, mockRange, mockSingle, mockLimit 
} = vi.hoisted(() => {
  ...
  describe('Dashboard Metrics', () => {
    it('requires admin authorization', async () => {
      ...
      Promise.all = vi.fn().mockResolvedValue([
        { count: 10 }, { count: 5 }, { count: 20 }, { count: 2 }, { count: 1 }, { data: [] }
      ])
