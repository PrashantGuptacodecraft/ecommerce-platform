-- 0015_enforce_checkout_total.sql
-- Enforce expected total during atomic checkout to ensure the customer is charged exactly what they reviewed.
...
BEGIN
  ...
  -- Verify total consistency to ensure customer is charged exactly what they reviewed
  IF v_total_paise != p_expected_total_paise THEN
    -- If the total changed since the customer reviewed the checkout summary, fail and rollback.
...
REVOKE ALL ON FUNCTION public.create_cod_order_atomic(TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.create_cod_order_atomic(TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER) FROM anon;
REVOKE ALL ON FUNCTION public.create_cod_order_atomic(TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.create_cod_order_atomic(TEXT, UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER) TO service_role;
